  ...
  return (
    <div id="soloo-header-container" className="w-full flex flex-col select-none border-b border-white/10 font-sans z-50 sticky top-0 bg-[#1a1a1a]/95 backdrop-blur-md">
      ...
      <header className="px-4 md:px-10 py-5 flex justify-between items-end bg-[#1a1a1a] relative">
        ...
        >
          <div className="bg-black/40 border-2 border-[#f97316] p-1.5 transition-colors group-hover:bg-[#f97316]/10">
            <CraneLogo className="w-9 h-9 md:w-11 md:h-11 text-[#f97316] group-hover:scale-110 transition-transform duration-200" />
          </div>
          <div className="flex flex-col">
            <div className="bg-[#f97316] text-black px-3 py-1.5 border border-black font-black uppercase tracking-tighter text-sm md:text-md italic leading-none transition-transform duration-150 group-hover:bg-white select-none shadow-[2px_2px_0px_0px_rgba(255,255,255,1)]">
              SOLOO TRUCKS<br />
              <span className="text-zinc-900 font-black font-sans text-[10px] tracking-widest block mt-0.5">RECOVERY</span>
            </div>
            <span className="text-[7.5px] uppercase tracking-[0.18em] text-[#f97316] font-black mt-0.5">East Africa Standby Fleet</span>
          </div>
        </button>
              ...
              <button
                ...
                className={`transition-colors duration-200 pb-1.5 border-b-2 ${
                  isActive
                    ...
                    : 'text-gray-400 border-transparent hover:text-[#f97316]'
                }`}
              >
                {item.label}
              </button>
        ...
        <div className="flex items-center gap-4">
          <a
            href="tel:0722154729"
            className="hidden sm:flex items-center gap-2 bg-[#f97316] hover:bg-white text-black font-black uppercase py-2 px-4 text-xs tracking-widest transition-colors rounded-sm"
          >
          ...
          <button
            ...
            className="lg:hidden p-2 text-[#f97316] hover:text-white transition-colors focus:outline-none"
        ...
        <div id="mobile-navigation-drawer" className="lg:hidden bg-[#1a1a1a] border-t border-white/10 py-4 px-4 space-y-4 animate-fade-in">
          ...
          <div className="bg-white/5 border border-white/10 p-4 rounded-sm space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <Phone className="w-3 h-3 text-[#f97316]" /> 0722154729
              </a>
              <a
                href="tel:0735154729"
                className="bg-black/40 hover:bg-black/60 text-white border border-white/10 py-2.5 rounded-sm text-[10px] font-black font-mono text-center flex items-center justify-center gap-1"
              >
                <Phone className="w-3 h-3 text-[#f97316]" /> 0735154729
              </a>
            </div>
          </div>
        </div>
